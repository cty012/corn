...
namespace corn {
    TextRenderImpl::Line::Line() : length(0), precedeWithLineFeed(false) {
        (void)length; (void)size; (void)precedeWithLineFeed;
    }

    TextRenderImpl::TextRenderImpl(const RichText& richText) : limitWidth(false) {
        (void)richText; (void)lines; (void)limitWidth;
    }

    void TextRenderImpl::setRichText(const RichText& richText, float padding) {
        (void)richText; (void)padding;
    }

    void TextRenderImpl::setWidth(float width, float padding) {
        (void)width; (void)padding;
    }
